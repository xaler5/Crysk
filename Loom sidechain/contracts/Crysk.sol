...
//--------------------Getters functions-----------------------------------------------//
    ...
    function getPlayerTeam(address adr) public view returns(string) {
        return players.getTeam(adr);
    }

    function getPlayerNickname(address adr) public view returns(string) {
...
//--------------------State changing functions------------------------------------------//
    ...
    function changeTeam(string name) external returns(bool) {
        string memory team = getPlayerTeam(msg.sender);
        logic.changeTeam(msg.sender, name);
    }

    function changeNickname(string name) external returns(bool) {
        string memory oldName = getPlayerNickname(msg.sender);
